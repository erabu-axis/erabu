  ...
  return (
    <article className="max-w-3xl">
      ...
      <section className="mb-10">
        ...
        <p className="mt-3 text-brand-inkSoft">
          購入先リンクの中には、提携先（Amazon・楽天市場等のASP）が発行する成果計測用のリンク・タグを利用しているものがあります。この場合、リンク先への遷移時に、GA4とは別に提携先自身の仕組みによる計測が行われます。当サイトはこの計測の仕組み自体を改変せず、提携先の定めるプライバシーポリシーに従って運用されます。
        </p>
      </section>
